                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            action ="<%=request.getContextPath()%>/add_task_member" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Mã Công Việc</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="id_DuAn"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Mã Dự Án" name="tenDuAn"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="id_NV"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="dd/MM/yyyy" name="ngayBatDau"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="dd/MM/yyyy" name="ngayKetThuc"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="tentrangThai"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=request.getContextPath()%>/task_list_member" class="btn btn-primary">Quay Lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
