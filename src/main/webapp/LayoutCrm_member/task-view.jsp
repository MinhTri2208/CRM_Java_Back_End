    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="<%=request.getContextPath()%>/LayoutCrm_admin/javascript:void(0)" data-toggle="collapse"
                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<%=request.getContextPath()%>/LayoutCrm_admin/profile.html">ThÃÂ´ng tin cÃÂ¡ nhÃÂ¢n</a></li>
                                <li><a href="<%=request.getContextPath()%>/LayoutCrm_admin/#">ThÃ¡Â»Âng kÃÂª cÃÂ´ng viÃ¡Â»Âc</a></li>
                                <li class="divider"></li>
                                <li><a href="<%=request.getContextPath()%>/LayoutCrm_admin/#">ÃÂÃÂng xuÃ¡ÂºÂ¥t</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="<%=request.getContextPath()%>/member" class="waves-effect"><i class="fa fa-clock-o fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">Dashboard</span></a>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath()%>/user_list_member" class="waves-effect"><i class="fa fa-user fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">Thành Viên</span></a>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath()%>/LayoutCrm_member/blank.html" class="waves-effect"><i class="fa fa-columns fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">Blank Page</span></a>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath()%>/LayoutCrm_member/404.html" class="waves-effect"><i class="fa fa-info-circle fa-fw"
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Xem Công Việc</h4>
                    </div>
                </div>
                <!-- /.row -->
                <% Task task =(Task) request.getAttribute("view_task") ;%>
                <!-- .row -->
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            action ="<%=request.getContextPath()%>/update_task" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Mã Dự Án</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="id_DuAn" value="<%=task.getId_DuAn() %>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="tenDuAn" value="<%=task.getTenDuAn() %>"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Mã Người Thực Hiện</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%=task.getId_NV() %>" name="id_NV"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%=task.getNgayBatDau() %>" name="ngayBatDau"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%=task.getNgayKetThuc() %>" name="ngayKetThuc"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%=task.getTenTrangThai() %>" name="tentrangThai"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
