        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
                <div class="navbar-header"> 
                    ...
                    <div class="top-left-part">
                        <a class="logo" href="<%=request.getContextPath()%>/member">
                            <b>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=request.getContextPath()%>/add_task_view_member" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        <c:forEach items="${list_task_member}" var="task">
        									<tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<%=request.getContextPath()%>/view_task_update_member?id_task=${task.getId_task()}" class="btn btn-sm btn-primary">Update</a>
                                                <a href="<%=request.getContextPath()%>/task_delete?id_task=${task.getId_task()}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="<%=request.getContextPath()%>/view_task_member?id_task=${task.getId_task()}" class="btn btn-sm btn-info">View</a>
                                            </td>
                                        	</tr>
        								</c:forEach>
                                    </tbody>
