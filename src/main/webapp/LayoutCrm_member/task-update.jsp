                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            action ="<%=request.getContextPath()%>/update_task_member" method="post">
                            <div class="form-group">
                                    <label class="col-md-12">Mã Công Việc</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="id_task" value="<%=task.getId_task() %>"
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=request.getContextPath()%>/task_list_member" class="btn btn-primary">Quay lÃ¡ÂºÂ¡i</a>
                                    </div>
                                </div>
                            </form>
                        </div>
