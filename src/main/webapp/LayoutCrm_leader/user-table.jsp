            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=request.getContextPath()%>/add_user_leader" class="btn btn-sm btn-success">Thêm</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                    ...
                                    <tbody>
        								...
        								<c:forEach items="${listNhanVien}" var="nhanViens">
                                            ...
                                            <td>
                                                ...
                                                <a href="<%=request.getContextPath()%>/view_update_leader?id=${nhanViens.getId_NV()}" class="btn btn-sm btn-primary">Update</a>
                                                <a href="<%=request.getContextPath()%>/delete?id=${nhanViens.getId_NV()}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="<%=request.getContextPath()%>/xem_leader?id=${nhanViens.getId_NV()}" class="btn btn-sm btn-info">View</a>
                                            </td>
                                        	</tr>
        								</c:forEach>
