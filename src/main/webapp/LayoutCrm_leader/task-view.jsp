            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">ThÃªm má»i cÃ´ng viá»c</h4>
                    </div>
                </div>
                <!-- /.row -->
                        ...
                        <div class="white-box">
                            ...
                            action ="<%=request.getContextPath()%>/update_task" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">MÃ£ Dá»± Ãn</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">TÃªn cÃ´ng viá»c</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">MÃ£ ngÆ°á»i thá»±c hiá»n</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">NgÃ y báº¯t Äáº§u</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">NgÃ y káº¿t thÃºc</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Tráº¡ng ThÃ¡i</label>
                                    <div class="col-md-12">
