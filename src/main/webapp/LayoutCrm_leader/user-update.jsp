        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
                <div class="navbar-header"> 
                    ...
                    <div class="top-left-part">
                        <a class="logo" href="<%=request.getContextPath()%>/LayoutCrm_admin/index.jsp">
                            <b>
                        ...
                        <div class="white-box">
                            ...
                            action="<%=request.getContextPath()%>/update" method="post">
                            	<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%=nhanVien.getHoTen() %>" value="<%=nhanVien.getId_NV() %>"
                                            class="form-control form-control-line" name="id"></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Full Name</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%=nhanVien.getHoTen() %>" value="<%=nhanVien.getHoTen() %>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="email" placeholder=""
                                            class="form-control form-control-line" value="<%= nhanVien.getEmail() %>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="password" name="matKhau" value="<%=nhanVien.getMatKhau() %>" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Phone No</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<%=nhanVien.getSdt() %>"
                                            class="form-control form-control-line" name="sdt"></div>
                                </div>
								<div class="form-group">
                                    <label class="col-md-12">Address</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<%=nhanVien.getDiaChi() %>"
                                            class="form-control form-control-line" name="diaChi">
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=request.getContextPath()%>/user_list_leader" method="get" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
