            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-2 col-sm-8 col-md-8 col-xs-3 text-right">
                        ...
                        <a href="<%=request.getContextPath()%>/add_task_view" class="btn btn-sm btn-link">Công việc</a>
                    </div>
                    <div class="col-lg-2 col-sm-8 col-md-8 col-xs-3 text-right">
                        <a href="<%=request.getContextPath()%>/add_task_view" class="btn btn-sm btn-link">Dự Án</a>
                    </div>
                    <div class="col-lg-2 col-sm-8 col-md-8 col-xs-3 text-right">
                        <a href="<%=request.getContextPath()%>/add_task_view" class="btn btn-sm btn-link">Người thực hiện</a>
                    </div>
                    <div class="col-lg-2 col-sm-8 col-md-8 col-xs-3 text-right">
                        <a href="<%=request.getContextPath()%>/add_task_view" class="btn btn-sm btn-link">Trạng thái</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
