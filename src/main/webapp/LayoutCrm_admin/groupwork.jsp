            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=request.getContextPath()%>/LayoutCrm_admin/groupwork-add.jsp" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                <form action ="<%=request.getContextPath()%>/search_duan" method="get">
						<div class="wrap">
						   <div class="search col-lg-3 pb-3">
						      <input type="text" name="id_DuAn" placeholder="Search id?">
					...
					<form action ="<%=request.getContextPath()%>/search_duan" method="get">
						<div class="wrap">
						   <div class="search col-lg-3 pb-3">
						      <input type="text" name="id_name" placeholder="Search tên dự án?">
						      <button type="submit" class="">
						        <i class="fa fa-search"></i>
						     </button>
						   </div>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listDuAns}" var="duAns">
                                            ...
                                            <td>
                                                ...
                                                <a href="<%=request.getContextPath()%>/view_update_duan?id_DuAn=${duAns.getId_DuAn()}" class="btn btn-sm btn-primary">Update</a>
                                                <a href="<%=request.getContextPath()%>/delete_duan?id_DuAn=${duAns.getId_DuAn()}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="<%=request.getContextPath()%>/duan_detail?id=${duAns.getId_DuAn()}" class="btn btn-sm btn-info">View</a>
                                            </td>
                                        	</tr>
        								</c:forEach>
                                    </tbody>
