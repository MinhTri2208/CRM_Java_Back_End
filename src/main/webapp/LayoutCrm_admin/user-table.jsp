...
<body>
                    ...
                    <ul class="nav navbar-top-links navbar-left m-l-20 hidden-xs">
                        <li>
                            <div role="search" class="app-search hidden-xs">
                                <input type="text" placeholder="Search id" name="id" class="form-control"> 
                                <a href="<%=request.getContextPath()%>/search_by_id">
                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="profile.html">Thông tin cá nh</a></li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=request.getContextPath()%>/add-user" class="btn btn-sm btn-success">Thêm</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
				<div class="search col-lg-3 pb-3">
						<form action ="<%=request.getContextPath()%>/search_by_id" method="get">
						  <input type="text" name="id_NV" placeholder="Search id?">
					...
					<div class="search col-lg-3 pb-3">
						<form action ="<%=request.getContextPath()%>/search_by_name" method="get">
						  <input type="text" name="hoTen" placeholder="Search name?">
						  <button type="submit" class="">
					        <i class="fa fa-search"></i>
					     </button>
						</form>
					...
					<div class="search col-lg-3 pb-3">
						<form action ="<%=request.getContextPath()%>/search_by_email" method="get">
					...
					<form action ="<%=request.getContextPath()%>/search_by_phone" method="get">
						<div class="wrap">
						   <div class="search col-lg-3 pb-3">
                            ...
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
        								...
        								<c:forEach items="${listNhanVien}" var="nhanViens">
        									<tr>
                                            <td><c:out value = "${nhanViens.getId_NV()}"/></td>
                                            <td><c:out value = "${nhanViens.getSdt()}"/></td>
                                            <td><c:out value = "${nhanViens.getEmail()}"/></td>
                                            <td><c:out value = "${nhanViens.getHoTen()}"/></td>
                                            <td><c:out value = "${nhanViens.getDiaChi()}"/></td>
                                            <td><c:out value = "${nhanViens.getId_role()}"/></td>
                                               
                                            <c:set var = "id_nv" scope = "session" value = "nhanViens.getId_NV()"/>
                                            <c:set var = "id_nv1"/>
                                            <td>
                                            
                                                <a href="<%=request.getContextPath()%>/view_update?id=${nhanViens.getId_NV()}" class="btn btn-sm btn-primary">Update</a>
                                                <a href="<%=request.getContextPath()%>/delete?id=${nhanViens.getId_NV()}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="<%=request.getContextPath()%>/task_status_user?id=${nhanViens.getId_NV()}" class="btn btn-sm btn-info">View</a>
                                            </td>
                                        	</tr>
        								</c:forEach>
    ...
    <script src="<%=request.getContextPath()%>/LayoutCrm_admin/js/jquery.dataTables.js"></script>
    <!--Wave Effects -->
