                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            action ="<%=request.getContextPath()%>/search_task" method="get">
                                <div class="form-group">
                                    <label class="col-md-12">STT</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="id_role"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="TÃªn cÃ´ng viá»c" name="id_name"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="mota"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success">LÆ°u láº¡i</button>
