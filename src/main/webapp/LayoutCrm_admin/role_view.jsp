<!DOCTYPE html>
<%@page import="com.cybersoft.crm_project.pojo.Roles"%>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            action ="<%=request.getContextPath()%>/role_add" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">STT</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<%= roles.getId_role() %>" name="id_role"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">TÃªn Quyá»n</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<%= roles.getId_name() %>" name="id_name"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">MÃ´ Táº£</label>
                                    <div class="col-md-12">
                                        <input type="text" name="mota" value="<%= roles.getMota() %>"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=request.getContextPath()%>/role_list" class="btn btn-primary">Quay láº¡i</a>
                                    </div>
                                </div>
                            </form>
                        </div>
