            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=request.getContextPath()%>/role_add_view" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
              <form action ="<%=request.getContextPath()%>/search_roles" method="get">
						<div class="wrap">
						   <div class="search col-lg-3 pb-3">
						      <input type="text" name="id_role" placeholder="Search id?">
					...
					<form action ="<%=request.getContextPath()%>/search_roles" method="get">
						<div class="wrap">
						   <div class="search col-lg-3 pb-3">
						      <input type="text" name="id_name" placeholder="Search name?">
						      <button type="submit" class="">
						        <i class="fa fa-search"></i>
						     </button>
						   </div>
                                ...
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listRoles}" var="roles">
                                            ...
                                            <td><c:out value = "${roles.getId_name()}"/></td>
                                            <td><c:out value = "${roles.getMota()}"/></td>
                                            
                                                                                       
                                            <td>
                                            
                                                <a href="<%=request.getContextPath()%>/role_view_update?id_role=${roles.getId_role()}" class="btn btn-sm btn-primary">Update</a>
                                                <a href="<%=request.getContextPath()%>/role_delete?id_role=${roles.getId_role()}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="<%=request.getContextPath()%>/role_view?id_role=${roles.getId_role()}" class="btn btn-sm btn-info">View</a>
                                            </td>
                                        	</tr>
        								</c:forEach>
                                    </tbody>
