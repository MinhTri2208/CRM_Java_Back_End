                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            action="<%=request.getContextPath()%>/update_duan" method="post">
                            	<div class="form-group">
                                    <label class="col-md-12">Mã dự án</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%= duAn.getId_DuAn() %>" 
                                            class="form-control form-control-line" name="id_DuAn"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Tên dự án</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%= duAn.getTenDuAn() %>" 
                                            class="form-control form-control-line" name="tenDuAn"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%= duAn.getNgayBatDau()%>" 
                                            class="form-control form-control-line" name="ngayBatDau"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%= duAn.getNgayKetThuc() %>" name="ngayKetThuc"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Tên trạng thái</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%= duAn.getTenTrangThai()%>" name="tenTrangThai"
                                             class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
	                                    <div class="col-sm-12">
	                                    	<button type="submit" class="btn btn-success">Sửa Dự Án</button>
