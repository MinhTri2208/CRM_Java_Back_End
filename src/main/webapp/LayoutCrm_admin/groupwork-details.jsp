...
<% String duAnName=(String) request.getAttribute("duAnName"); %>
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <%int count2=(int) request.getAttribute("count2"); %>
                                    <h3 class="counter text-right m-t-15 text-megna"><%=count2 %></h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic"
                                        data-icon="&#xe00b;"></i>
                                    <h5 class="text-muted vb">Hoành thành</h5>
                                </div>
                                 <%int count1=(int) request.getAttribute("count1"); %>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right m-t-15 text-primary"><%=count1 %></h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <c:forEach items="${taskCHT}" var="tasks">
                            	<div class="message-center">
	                                <a href="<%=request.getContextPath()%>/LayoutCrm_admin/#">
	                                    <div class="mail-contnet">
	                                    	<h4>Tên Nhân Viên : <c:out value = "${tasks.getTenNhanVien()}"/></h4>
	                                        <h5>Tên Công Việc : <c:out value = "${tasks.getTenProject()}"/></h5>
	                                        <span class="mail-desc"></span>
	                                        <span class="time">Ngày Bắt Đầu: <c:out value = "${tasks.getNgayBatDau()}"/></span>
	                                        <span class="time">Ngày Kết Thúc: <c:out value = "${tasks.getNgayKetThuc()}"/></span>
	                                    </div>
	                                </a>
	                            </div>
                                </c:forEach>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <c:forEach items="${taskDTH}" var="tasks">
                            	<div class="message-center">
	                                <a href="<%=request.getContextPath()%>/LayoutCrm_admin/#">
	                                    <div class="mail-contnet">
	                                    	<h5>Tên Nhân Viên : <c:out value = "${tasks.getTenNhanVien()}"/></h5>
	                                    	<br>
	                                        <h5>Tên Công Việc : <c:out value = "${tasks.getTenProject()}"/></h5>
	                                        <span class="mail-desc"></span>
	                                        <span class="time">Ngày Bắt Đầu: <c:out value = "${tasks.getNgayBatDau()}"/></span>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <c:forEach items="${taskDHT}" var="tasks">
                            	<div class="message-center">
	                                <a href="<%=request.getContextPath()%>/LayoutCrm_admin/#">
	                                    <div class="mail-contnet">
	                                    	<h4>Tên Nhân Viên : <c:out value = "${tasks.getTenNhanVien()}"/></h4>
