                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            action ="<%=request.getContextPath()%>/role_update" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">STT</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%= roles.getId_role() %>" name="id_role"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%= roles.getId_name() %>" name="id_name"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="mota" placeholder="<%= roles.getMota() %>"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=request.getContextPath()%>/role_list" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
