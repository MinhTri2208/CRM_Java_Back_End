                        ...
                        <div class="white-box">
                            ...
                            action ="<%=request.getContextPath()%>/update_task" method="post">
                            	<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%=task.getId_DuAn() %>" name="id_task" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%=task.getId_DuAn() %>" name="id_DuAn"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="<%=task.getTenDuAn() %>" name="tenDuAn" 
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=request.getContextPath()%>/task_list" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
